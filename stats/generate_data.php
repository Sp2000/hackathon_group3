<?php 
	...
	//$objTaxons=[["2137144", "NL"], ["5754745", "NL"]];
	...
	foreach ($objTaxons as $key => $taxon) {
		...
		$basisOfRecords= getOccurrencesByBasisOfRecords($taxon[1], $taxon[0]);
		$dates=getOccurrencesByDates($taxon[1], $taxon[0], $totalOccurrences);
